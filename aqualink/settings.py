"""
Django settings for aqualink project.
...
#used sessions for store cart information
    'django.contrib.sessions',

#used messages for giving user feedback
...
WSGI_APPLICATION = 'aqualink.wsgi.application'
